...
public class Dungeon6 {
	...
	public static void main(String[] args) {
		...
		Dungeon6 dungeon = new Dungeon6();
		
		int goldSteps = dungeon.numberOfSteps(dim, player, gold, 0);
		int monsterSteps = dungeon.numberOfSteps(dim, monster, gold, 1);
	...
	public int numberOfSteps(int[] dim, int[] player, int[] gold, int type) {
